...
def quantize(
  ...
  if (
      ...
      and (
          gfile
          and gfile.Exists(output_litertlm)
          or os.path.exists(output_litertlm)
      )
  ):
    if gfile and gfile.Exists(output_litertlm):
      gfile.Remove(output_litertlm)
    elif os.path.exists(output_litertlm):
      os.remove(output_litertlm)
  unpacked = {}
  if input_litertlm:
  ...
  if output_litertlm:
    ...
    litertlm_utils.pack_litertlm(
        ...
        prefilldecode_model_path=output_path,
