...
class ExportLibTest(parameterized.TestCase):
  ...
  def test_build_llm_metadata_gemma3_270m_override(self):
    ...
    export_config = export_lib.exportable_module_config.ExportableModuleConfig(
        model="dummy_model",
        litert_lm_model_type_override="gemma3_270m",
    )
    ...
    self.assertTrue(metadata.llm_model_type.HasField("gemma3270m"))
