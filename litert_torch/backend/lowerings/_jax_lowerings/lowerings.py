...
def lower_by_torchax(op):
  return lower_by_jax(op)(torchax_ops.ALL_OPS[op])


lower_by_torchax(torch.ops.aten._adaptive_avg_pool2d)
lower_by_torchax(torch.ops.aten._adaptive_avg_pool3d)
lower_by_torchax(torch.ops.aten._cdist_forward)
lower_by_torchax(torch.ops.aten._local_scalar_dense)
lower_by_torchax(torch.ops.aten._log_softmax)
lower_by_torchax(torch.ops.aten._pdist_forward)
lower_by_torchax(torch.ops.aten._softmax)
lower_by_torchax(torch.ops.aten._unsafe_index)
lower_by_torchax(torch.ops.aten._unsafe_view)
lower_by_torchax(torch.ops.aten.acos)
lower_by_torchax(torch.ops.aten.acosh)
lower_by_torchax(torch.ops.aten.addbmm.default)
lower_by_torchax(torch.ops.aten.addmm)
lower_by_torchax(torch.ops.aten.addmv)
lower_by_torchax(torch.ops.aten.alias)
lower_by_torchax(torch.ops.aten.allclose)
lower_by_torchax(torch.ops.aten.amax)
lower_by_torchax(torch.ops.aten.amin)
lower_by_torchax(torch.ops.aten.any)
lower_by_torchax(torch.ops.aten.arange.default)
lower_by_torchax(torch.ops.aten.arange.start)
lower_by_torchax(torch.ops.aten.arange.start_step)
lower_by_torchax(torch.ops.aten.argmax)
lower_by_torchax(torch.ops.aten.argmin)
lower_by_torchax(torch.ops.aten.as_strided)
lower_by_torchax(torch.ops.aten.as_strided_copy)
lower_by_torchax(torch.ops.aten.asin)
lower_by_torchax(torch.ops.aten.asinh)
lower_by_torchax(torch.ops.aten.atan)
lower_by_torchax(torch.ops.aten.atan2)
lower_by_torchax(torch.ops.aten.atanh)
lower_by_torchax(torch.ops.aten.avg_pool2d)
lower_by_torchax(torch.ops.aten.avg_pool3d)
lower_by_torchax(torch.ops.aten.bitwise_and)
lower_by_torchax(torch.ops.aten.bitwise_not)
lower_by_torchax(torch.ops.aten.bitwise_or)
lower_by_torchax(torch.ops.aten.bitwise_xor)
lower_by_torchax(torch.ops.aten.bmm)
lower_by_torchax(torch.ops.aten.ceil)
lower_by_torchax(torch.ops.aten.clamp.Tensor)
lower_by_torchax(torch.ops.aten.clamp.default)
lower_by_torchax(torch.ops.aten.clone)
lower_by_torchax(torch.ops.aten.clone.default)
lower_by_torchax(torch.ops.aten.constant_pad_nd)
lower_by_torchax(torch.ops.aten.cos)
lower_by_torchax(torch.ops.aten.cosh)
lower_by_torchax(torch.ops.aten.cumsum)
lower_by_torchax(torch.ops.aten.detach)
lower_by_torchax(torch.ops.aten.diagonal)
lower_by_torchax(torch.ops.aten.dot)
lower_by_torchax(torch.ops.aten.embedding)
lower_by_torchax(torch.ops.aten.empty)
lower_by_torchax(torch.ops.aten.eq)
lower_by_torchax(torch.ops.aten.erf)
lower_by_torchax(torch.ops.aten.exp)
lower_by_torchax(torch.ops.aten.expand)
lower_by_torchax(torch.ops.aten.expand_copy)
lower_by_torchax(torch.ops.aten.expm1)
lower_by_torchax(torch.ops.aten.fill)
lower_by_torchax(torch.ops.aten.flip)
lower_by_torchax(torch.ops.aten.fmod)
lower_by_torchax(torch.ops.aten.full)
lower_by_torchax(torch.ops.aten.full_like)
lower_by_torchax(torch.ops.aten.gather)
lower_by_torchax(torch.ops.aten.ge)
lower_by_torchax(torch.ops.aten.gelu)
lower_by_torchax(torch.ops.aten.glu)
lower_by_torchax(torch.ops.aten.glu.default)
lower_by_torchax(torch.ops.aten.gt)
lower_by_torchax(torch.ops.aten.hardtanh)
lower_by_torchax(torch.ops.aten.index)
lower_by_torchax(torch.ops.aten.index.Tensor)
lower_by_torchax(torch.ops.aten.index_copy)
lower_by_torchax(torch.ops.aten.index_put)
lower_by_torchax(torch.ops.aten.index_select)
lower_by_torchax(torch.ops.aten.isinf)
lower_by_torchax(torch.ops.aten.isnan)
lower_by_torchax(torch.ops.aten.le)
lower_by_torchax(torch.ops.aten.leaky_relu)
lower_by_torchax(torch.ops.aten.lift_fresh_copy)
lower_by_torchax(torch.ops.aten.linalg_vector_norm)
lower_by_torchax(torch.ops.aten.log)
lower_by_torchax(torch.ops.aten.log10)
lower_by_torchax(torch.ops.aten.log1p)
lower_by_torchax(torch.ops.aten.log2)
lower_by_torchax(torch.ops.aten.logical_and)
lower_by_torchax(torch.ops.aten.logical_not)
lower_by_torchax(torch.ops.aten.logical_or)
lower_by_torchax(torch.ops.aten.logical_xor)
lower_by_torchax(torch.ops.aten.max)
lower_by_torchax(torch.ops.aten.max_pool2d_with_indices_backward)
lower_by_torchax(torch.ops.aten.maximum)
lower_by_torchax(torch.ops.aten.mean)
lower_by_torchax(torch.ops.aten.min)
lower_by_torchax(torch.ops.aten.minimum)
lower_by_torchax(torch.ops.aten.mm)
lower_by_torchax(torch.ops.aten.native_batch_norm)
lower_by_torchax(torch.ops.aten.native_layer_norm_backward)
lower_by_torchax(torch.ops.aten.ne)
lower_by_torchax(torch.ops.aten.neg)
lower_by_torchax(torch.ops.aten.nonzero)
lower_by_torchax(torch.ops.aten.outer)
lower_by_torchax(torch.ops.aten.permute)
lower_by_torchax(torch.ops.aten.permute_copy)
lower_by_torchax(torch.ops.aten.pow)
lower_by_torchax(torch.ops.aten.prod)
lower_by_torchax(torch.ops.aten.reciprocal)
lower_by_torchax(torch.ops.aten.reflection_pad1d)
lower_by_torchax(torch.ops.aten.relu)
lower_by_torchax(torch.ops.aten.remainder)
lower_by_torchax(torch.ops.aten.repeat)
lower_by_torchax(torch.ops.aten.reshape)
lower_by_torchax(torch.ops.aten.roll)
lower_by_torchax(torch.ops.aten.round)
lower_by_torchax(torch.ops.aten.rsqrt)
lower_by_torchax(torch.ops.aten.scalar_tensor)
lower_by_torchax(torch.ops.aten.scatter.src)
lower_by_torchax(torch.ops.aten.scatter.value)
lower_by_torchax(torch.ops.aten.scatter_add)
lower_by_torchax(torch.ops.aten.scatter_reduce)
lower_by_torchax(torch.ops.aten.select)
lower_by_torchax(torch.ops.aten.select_copy)
lower_by_torchax(torch.ops.aten.select_scatter)
lower_by_torchax(torch.ops.aten.sigmoid)
lower_by_torchax(torch.ops.aten.sign)
...
lower_by_torchax(torch.ops.aten.split_with_sizes)
lower_by_torchax(torch.ops.aten.sqrt)
lower_by_torchax(torch.ops.aten.squeeze)
lower_by_torchax(torch.ops.aten.squeeze_copy)
lower_by_torchax(torch.ops.aten.stack)
lower_by_torchax(torch.ops.aten.sum)
lower_by_torchax(torch.ops.aten.t)
lower_by_torchax(torch.ops.aten.tan)
lower_by_torchax(torch.ops.aten.tanh)
lower_by_torchax(torch.ops.aten.tensor_split.sections)
lower_by_torchax(torch.ops.aten.to.device)
lower_by_torchax(torch.ops.aten.to.dtype)
lower_by_torchax(torch.ops.aten.transpose)
lower_by_torchax(torch.ops.aten.transpose_copy)
lower_by_torchax(torch.ops.aten.triu)
lower_by_torchax(torch.ops.aten.true_divide)
lower_by_torchax(torch.ops.aten.trunc)
lower_by_torchax(torch.ops.aten.unbind_copy)
lower_by_torchax(torch.ops.aten.unsqueeze)
lower_by_torchax(torch.ops.aten.unsqueeze.default)
lower_by_torchax(torch.ops.aten.unsqueeze_copy)
lower_by_torchax(torch.ops.aten.var.correction)
lower_by_torchax(torch.ops.aten.var_mean.correction)
lower_by_torchax(torch.ops.aten.view)
lower_by_torchax(torch.ops.aten.view_as_complex)
lower_by_torchax(torch.ops.aten.view_as_real)
lower_by_torchax(torch.ops.aten.view_copy)
lower_by_torchax(torch.ops.aten.where.ScalarOther)
lower_by_torchax(torch.ops.aten.where.ScalarSelf)
lower_by_torchax(torch.ops.prims.broadcast_in_dim)
lower_by_torchax(torch.ops.prims.var)
...
def _aten_copy(self, src, **kwargs):
  return torchax_ops.ALL_OPS[torch.ops.aten.copy](self, src)
