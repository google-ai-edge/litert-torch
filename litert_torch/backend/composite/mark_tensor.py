...
mark_tensor_op = torch.ops.litert_torch.mark_tensor.default


@torch.library.impl(
    _torch_library.LITERT_TORCH_LIB, "mark_tensor", "CompositeExplicitAutograd"
)
def mark_tensor(
...
@torch.library.impl(_torch_library.LITERT_TORCH_LIB, "mark_tensor", "Meta")
...
@lowerings.lower(torch.ops.litert_torch.mark_tensor)
